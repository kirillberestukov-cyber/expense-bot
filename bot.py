...
CHANNEL_POSTS = [
    ...
    "🛒 <b>«Мелкая покупка» — ловушка мозга</b>\n\n"
    "Шоколадка за 80₽. Жвачка за 50₽. Вода за 70₽.\n"
    "По отдельности — ничто. За месяц — 5 000-7 000₽.\n\n"
    "Мозг не считает траты меньше 200₽ за «настоящие». А кошелёк считает.",

    "🎮 <b>Донаты в играх — тихий убийца бюджета</b>\n\n"
    "«Всего 100₽ за скин» × 3 раза в неделю = 1 200₽/мес = 14 400₽/год.\n\n"
    "Не говорю «не донать». Говорю: запиши и посмотри сумму за месяц. "
    "Дальше сам решишь.",

    "📱 <b>Сколько ты платишь за подписки?</b>\n\n"
    "Прямо сейчас посчитай:\n"
    "YouTube Premium + Spotify + iCloud + Game Pass + …\n\n"
    "Большинство людей не знают точную сумму. А она обычно в 2 раза больше, чем кажется.",

    "🧮 <b>Математика карманных денег</b>\n\n"
    "Получаешь 500₽ в день на карманные?\n"
    "Это 15 000₽/мес. Это 180 000₽/год.\n\n"
    "Если откладывать хотя бы 20% — через год будет 36 000₽. "
    "Хватит на хорошие наушники или гаджет.",

    "🤔 <b>Тест: ты знаешь свои расходы?</b>\n\n"
    "Не подглядывая, ответь:\n"
    "1. Сколько потратил вчера?\n"
    "2. Какая твоя самая дорогая категория?\n"
    "3. Сколько в среднем тратишь в день?\n\n"
    "Если хоть один ответ — «не знаю», пора начать записывать.",

    "💳 <b>Ловушка безналичных платежей</b>\n\n"
    "Когда платишь картой или телефоном, ты не чувствуешь, как уходят деньги.\n"
    "С наличкой ты видишь, как купюры заканчиваются.\n\n"
    "Запись расхода сразу после покупки — цифровой аналог «ощущения денег».",

    "📈 <b>Зачем сравнивать месяцы?</b>\n\n"
    "В сентябре потратил больше, чем в августе? Почему?\n"
    "Школа, новая одежда, учебники — или просто расслабился?\n\n"
    "Сравнение месяцев показывает тренд. Тренд — это то, что можно исправить.",

    "🎒 <b>Расходы на школу</b>\n\n"
    "Буфет, канцелярия, проезд, обеды…\n"
    "Школа — это не бесплатно, даже если за учёбу не платишь.\n\n"
    "Создай категорию «🎒 Школа» и отслеживай. Сам удивишься цифре.",

    "⏰ <b>2 минуты, которые меняют всё</b>\n\n"
    "Записать расход = 10 секунд.\n"
    "Посмотреть статистику = 5 секунд.\n"
    "Понять, куда уходят деньги = бесценно.\n\n"
    "Две минуты в день — и ты контролируешь свои финансы.",

    "🏆 <b>Челлендж: неделя без лишних трат</b>\n\n"
    "Правила:\n"
    "1. Записывай вообще всё\n"
    "2. Перед каждой покупкой спроси: «мне это нужно?»\n"
    "3. В конце недели посмотри статистику\n\n"
    "Спорим, сэкономишь минимум 30%?",

    "🔥 <b>Первый шаг — самый важный</b>\n\n"
    "Не нужно идеально вести бюджет с первого дня.\n"
    "Не нужно записывать всё до копейки.\n\n"
    "Просто начни. Хотя бы крупные траты. "
    "Через неделю это станет привычкой.",

    "🧊 <b>Метод «заморозки»</b>\n\n"
    "Хочешь что-то купить? Добавь в список желаний и «заморозь» на 3 дня.\n"
    "Через 3 дня 70% вещей из списка уже не хочется.\n\n"
    "Работает лучше любой силы воли.",

    "💡 <b>Разница между «хочу» и «нужно»</b>\n\n"
    "Нужно: еда, проезд, учёба.\n"
    "Хочу: новый скин, сладости, такси вместо автобуса.\n\n"
    "Обе категории нормальные. Главное — знать пропорцию.\n"
    "Если «хочу» > 60%, стоит задуматься.",

    "📊 <b>Твоя статистика не врёт</b>\n\n"
    "Можно обманывать себя: «я мало трачу», «это была разовая покупка».\n"
    "Но цифры не врут.\n\n"
    "Один взгляд на статистику за месяц — и всё понятно без слов.",

    "🗓 <b>Начало месяца — лучшее время</b>\n\n"
    "Установи бюджеты на категории в первый день месяца.\n"
    "Поставь цель: потратить меньше, чем в прошлом.\n\n"
    "В конце месяца сравни. Это как игра — побей свой рекорд.",

    "🌟 <b>Финансовая грамотность — суперсила</b>\n\n"
    "Большинство взрослых не умеют управлять деньгами.\n"
    "Если ты начнёшь в 12-15 лет — к 20 годам будешь впереди 90% людей.\n\n"
    "Серьёзно. Это та привычка, которая окупится сильнее всего.",

    "🎯 <b>Маленькие цели > большие мечты</b>\n\n"
    "«Накопить миллион» — звучит красиво, но пугает.\n"
    "«Накопить 5 000₽ за месяц» — звучит реально.\n\n"
    "Начинай с маленьких целей. Каждая достигнутая цель — новый уровень мотивации.",

    "🔔 <b>Почему лимиты работают</b>\n\n"
    "Поставил лимит 500₽/день.\n"
    "Утром купил завтрак за 200₽. Осталось 300₽.\n"
    "Перед обедом уже думаешь: «а стоит ли?»\n\n"
    "Лимит не запрещает тратить. Он заставляет думать перед тратой.",

    "👀 <b>Эксперимент: записывай 7 дней</b>\n\n"
    "Не меняй привычки. Просто записывай каждый расход 7 дней подряд.\n"
    "Ничего не ограничивай. Трать как обычно.\n\n"
    "На 8-й день посмотри статистику.\n"
